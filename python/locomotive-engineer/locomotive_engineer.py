...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    :return: list - list of wagons.
    """
    x, y, z,  *remaining = each_wagons_id
    *combine, = z, *missing_wagons, *remaining,  x, y
...
def add_missing_stops(dicta, **kwargs,):
    ...
    for key, value in kwargs.items():
        city.append(value)
    dictab = {"Stop": city}
    return {**dicta, **dictab} #**d1 and **d2 unpack the key-value pairs of d1 and d2 into the new dictionary d3.

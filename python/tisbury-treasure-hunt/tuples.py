...
def compare_records(azara_record, rui_record):
    ...
    coordinate_azara = get_coordinate(azara_record)
    coordinate_azara_format = convert_coordinate(coordinate_azara)
    coordiate_rui = rui_record[1]
    return coordinate_azara_format == coordiate_rui
...
def clean_up(combined_record_group):
    ...
    for item in combined_record_group:
        new_value = item[0:1] + item[2:]
        result_string +=f"{new_value}\n"
